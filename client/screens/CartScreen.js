...
export default function CartScreen() {
  ...
  return (
    <View className="bg-white flex-1">
      ...
      >
        <Image source={require("../assets/images/deliveryMoto.png")} className="w-20 h-20 rounded-full" />
      ...
      >
        ...
        <View className="flex-row justify-between">
          ...
          <Text className="text-gray-900 font-extrabold">${cartTotal + deliveryFee}</Text>
        </View>
        <View>
          <TouchableOpacity
